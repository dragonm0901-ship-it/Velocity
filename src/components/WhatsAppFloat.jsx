  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center group">
      ...
      <a
        ...
        className="bg-[#25D366] text-pureWhite p-4 rounded-full shadow-2xl hover:scale-110 transition-transform duration-300 flex items-center justify-center relative overflow-hidden group-hover:shadow-[0_0_20px_rgba(37,211,102,0.5)]"
